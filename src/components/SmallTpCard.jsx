...
function SmallTpCard(props) {
  return (
    <div
      className={`flex flex-col items-center rounded-md px-2 py-2 ${props.bgColor} space-y-1 h-[200px]  md:w-[700px]
                     md:flex-row md:h-[100%] md:justify-evenly
                     
                     `}
    >
      <div
        className="flex flex-col space-y-1 h-[53%] w-full 
                        md:h-full md:w-[50%]
                        lg:w-[50%] lg:h-[100%] lg:space-y-0 lg:justify-center
                        "
      >
        <h3
          className="text-body-background text-[14px] font-bold
                           text-sm
                           lg:text-lg
                           xl:text-2xl"
        >
        ...
        <button
          className="flex gap-2 text-special-element text-sm
